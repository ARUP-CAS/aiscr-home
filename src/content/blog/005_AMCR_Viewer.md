...
date: "2026-05-13" # Datum, které se zobrazí u příspěvku (typicky den, kdy byl příspěvek publikován)
category: "Novinka"
published: true
locale: "cs"
...
![Příklad vizualizace proběhlých výzkumů (archeologických akcí) v Jihomoravském kraji, při kterých byly nalezeny památky z doby laténské.](/images/blog/005/005_001.webp)
