		...
		<div class="flex justify-between items-center h-full">
			...
			<div class="hidden lg:flex items-center">
				...
				<div class="flex items-center" style="gap: 12px;">
					...
					<a href="https://linkedin.com" class="text-white hover:text-gray-300 transition-colors" aria-label={m['aria.linkedin']()}>
						<Linkedin size="20" />
					</a>
					<a href="https://youtube.com" class="text-white hover:text-gray-300 transition-colors" aria-label={m['aria.youtube']()}>
						<Youtube size="20" />
					</a>
					<a href="https://bsky.app" class="text-white hover:text-gray-300 transition-colors" aria-label={m['aria.bluesky']()}>
					...
					<a href="https://github.com" class="text-white hover:text-gray-300 transition-colors" aria-label={m['aria.github']()}>
						<Github size="20" />
					</a>
				</div>
			</div>
